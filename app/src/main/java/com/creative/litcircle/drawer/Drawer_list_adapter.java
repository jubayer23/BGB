package com.creative.litcircle.drawer;
...
public class Drawer_list_adapter extends BaseExpandableListAdapter {
    ...
    private int getResourceId(String headerTitle) {
        if (headerTitle.equalsIgnoreCase(HomeActivity.DRAWER_LIST_MAP)) {
            return R.drawable.drawer_map;
        }

        if (headerTitle.equalsIgnoreCase(HomeActivity.DRAWER_LIST_NEWENTRY)) {
            return R.drawable.drawer_devices;
        }

        if (headerTitle.equalsIgnoreCase(HomeActivity.DRAWER_LIST_ACCOUNT)) {
            return R.drawable.drawer_setting;
        }
        if (headerTitle.equalsIgnoreCase(HomeActivity.DRAWER_LIST_SIGNOUT)) {
